...
public class 类和对象_java中的构造方法 {
    ...
    * */
    ...
    public 类和对象_java中的构造方法(float newScreen, float newCpu, float newGpu) {
        // 通过自定义条件，可以对传入参数做处理。
        if (newScreen < 3.5f) {
    ...
    public static void main(String[] args) {
        /*通过无参数的构造方法创建对象*/
        类和对象_java中的构造方法 telPhone = new 类和对象_java中的构造方法();

        /*有参的构造方法创建对象,并且可以给对象中的实例变量赋初始值*/
        类和对象_java中的构造方法 telPhone2 = new 类和对象_java中的构造方法(0.5f, 0.5f, 2f);
    }
